...
from observability.agent_tracer import AgentTracer, TraceStore, build_mcp_detail, trace_store
...
tracer.emit("atlas", "tavily_search", "Found 14 topics", "done",
...
tracer.emit("chrono", "google_calendar", "Checking free slots for tomorrow...", "running")
...
print(f"  ✓ state writes: {detail.session_state_writes[0].key} → {detail.session_state_writes[0].value_summary}")
...
print("\n✅ AgentTracer OK — Phase 2 complete!")
